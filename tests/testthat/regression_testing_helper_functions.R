...
PLANT_TESTING_INFO <- list(
    specify_crop("miscanthus_x_giganteus", miscanthus_x_giganteus_initial_values, miscanthus_x_giganteus_parameters, WEATHER,             miscanthus_x_giganteus_direct_modules, miscanthus_x_giganteus_differential_modules, miscanthus_x_giganteus_ode_solver, MISCANTHUS_X_GIGANTEUS_IGNORE), # INDEX = 1
    specify_crop("willow",                 willow_initial_values,                 willow_parameters,                 WEATHER,             willow_direct_modules,                 willow_differential_modules,                 willow_ode_solver,                 WILLOW_IGNORE),                 # INDEX = 2
    specify_crop("soybean",                soybean_initial_values,                soybean_parameters,                soybean_weather2002, soybean_direct_modules,                soybean_differential_modules,                soybean_ode_solver,                SOYBEAN_IGNORE)                 # INDEX = 3
)
